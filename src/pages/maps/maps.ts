...
export class MapsPage implements OnInit {
  ...
  choosePlace(place: MapPlace) {
    ...
    if (!place.selected) {
      ...
      place.select();
      env.choosenPlace = new PlaceModel();
      env.choosenPlace.name = place.details.name;
      env.choosenPlace.placeId = place.details.place_id;
      env.choosenPlace.address = place.details.vicinity;
      env.choosenPlace.latitude = place.location.lat();
      env.choosenPlace.longitude = place.location.lng();
